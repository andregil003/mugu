  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-10 lg:py-16">
      <div className="hero-gradient rounded-3xl p-8 text-center text-white shadow-xl lg:p-12">
        ...
        <p className="mx-auto mt-3 max-w-md text-base leading-relaxed text-green-100">
          {t('tagline')}
        </p>

        <Button
          size="lg"
          className="mt-8 mx-auto w-full max-w-sm rounded-xl bg-white py-6 text-lg font-bold text-green-900 shadow-lg transition hover:bg-green-50 hover:shadow-xl active:scale-[0.98] lg:w-auto lg:px-10 dark:bg-card dark:text-foreground dark:hover:bg-muted"
